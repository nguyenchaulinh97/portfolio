    ...
    >
      {!isFinished && !(myText[1].length == 0) && (
        <>
          ...
          <Footer className="absolute bottom-0" link="https://github.com/nguyenchaulinh97/portfolio" />
        </>
      )}
      ...
      {isFinished && (
        <>
          ...
          />
          <Footer className="pt-16" link="https://github.com/nguyenchaulinh97/portfolio" />
        </>
      )}
    </div>
  );
