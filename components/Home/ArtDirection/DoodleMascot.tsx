...
export default function DoodleMascot({
  ...
  return (
    ...
    >
      <div className="absolute right-0 top-0 max-w-[160px] rotate-[5deg] rounded-[22px] border-2 border-[#24335b]/10 bg-[#fff8ea] px-4 py-3 text-[#17223f] shadow-[10px_10px_0_rgba(23,34,63,0.12)]">
      ...
      <div className="absolute bottom-[38px] left-[30px] flex h-[74px] w-[74px] items-center justify-center rounded-[24px] border-2 border-[#24335b] bg-[#213259]">
        <div className="absolute left-4 top-[24px] h-3 w-3 rounded-full bg-[#fff8e7]" />
        <div className="absolute right-4 top-[24px] h-3 w-3 rounded-full bg-[#fff8e7]" />
        <div className="absolute bottom-[18px] h-[10px] w-10 rounded-b-full border-b-[3px] border-[#85e7dc]" />
      </div>
