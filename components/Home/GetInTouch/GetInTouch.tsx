  ...
  return (
    ...
    >
      ...
      <p className="flex font-Header tracking-wider text-gray-400 text-center px-6 sm:px-16 md:px-0 md:w-[600px]">
        I&apos;m always open to discussing product roles, frontend engineering opportunities, and teams working on
        thoughtful digital experiences. If you think we should talk, feel free to reach out.
      </p>
      <div className="pt-4">
        {isAndroidWebView ? (
          <button
