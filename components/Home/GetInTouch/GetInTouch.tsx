  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[1200px]">
        ...
        <div className="comic-panel relative mt-10 overflow-hidden rounded-[36px] p-6 sm:p-8 xl:p-10">
          ...
          <div className="relative grid gap-8 xl:grid-cols-[1.04fr_0.96fr]">
            <div className="space-y-6">
              <div className="paper-grid rounded-[30px] border-2 border-[#24335b]/10 bg-[#fff6df] p-6 text-[#17223f] shadow-[14px_14px_0_rgba(23,34,63,0.14)] sm:p-8">
                ...
                <h3 className="mt-6 font-Header text-3xl leading-tight sm:text-4xl">
              ...
              <div className="rounded-[28px] border border-white/[0.12] bg-white/[0.06] px-5 py-5 text-sm leading-7 text-[#d5ddf2]">
            ...
            <div className="flex flex-col gap-6">
              <div className="rounded-[32px] border-2 border-[#24335b]/10 bg-[#fff6df] p-6 text-[#17223f] shadow-[14px_14px_0_rgba(23,34,63,0.14)] sm:p-8">
                <div className="font-Mono text-[11px] uppercase tracking-[0.22em] text-[#5a6f99]">Best way to reach me</div>

                <div className="mt-4 font-Header text-3xl leading-tight">nguyenchaulinh97@gmail.com</div>
                ...
                <div className="mt-7">
                  {isAndroidWebView ? (
                    <button className="rounded-full border border-[#24335b]/10 bg-[#24335b] px-8 py-4 font-Header text-sm font-bold uppercase tracking-[0.16em] text-[#ffe3a8] shadow-[0_12px_24px_rgba(23,34,63,0.14)]">
                      nguyenchaulinh97@gmail.com
                    </button>
                  ) : (
                    <a href="mailto:nguyenchaulinh97@gmail.com" target={"_blank"} rel="noreferrer">
                      <button className="resume-button-hover rounded-full border border-AAsecondary/60 bg-AAsecondary px-8 py-4 font-Header text-sm font-bold uppercase tracking-[0.16em] text-[#17223f] transition duration-300">
                        Email Me
                      </button>
                    </a>
                  )}
